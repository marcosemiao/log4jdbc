...
public class ResultSetHandler implements MessageFactory {
  ...
  public MessageHandlerImpl transformMessage(final Object proxy, final Method method, final Object[] args,
    ...
    final boolean wasNullMethod = nameMethod.equals("wasNull") && lastCell != null && invoke != null
    ...
    final boolean getValueColumn = nameMethod.startsWith("get") && targetException == null && args != null
        && args.length > 0;
    if (getValueColumn) {
