...
public abstract class AbstractRewriteDataSource extends AbstractDataSource {
	...
	invokeMethod("setSqljEnableClassLoaderSpecificProfiles", Boolean.valueOf(sqljEnableClassLoaderSpecificProfiles), Boolean.TYPE);
    }

    public boolean getSqljEnableClassLoaderSpecificProfiles(final Properties paramProperties) {
	final Boolean value = (Boolean) invokeMethod("getSqljEnableClassLoaderSpecificProfiles", paramProperties, Boolean.TYPE);
	return value.booleanValue();
    }
