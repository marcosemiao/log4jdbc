...
public class PreparedStatementSqlOperationLogger implements SqlOperationLogger {

	private final static String TYPE_LOGGER = SqlOperationLogger.PREPARED_STATEMENT;
	...
	public void buildLog(final SqlOperation sqlOperation, final Method method, final Object[] args,
			final Object invoke) {
