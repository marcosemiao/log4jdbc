...
````
ou
https://repo1.maven.org/maven2/com/github/marcosemiao/log4jdbc/log4jdbc-file/0.1.1/log4jdbc-file-0.1.1.jar
...
````	
ou
https://repo1.maven.org/maven2/com/github/marcosemiao/log4jdbc/log4jdbc-marshaller/0.1.1/log4jdbc-marshaller-0.1.1.jar

ou simplement copier le fichier "log4jdbc-marshaller-0.1.1.jar" dans le répertoire lib.

**Exemple :**

jboss-5.0.1.GA\server\default\lib\log4jdbc-marshaller-0.1.1.jar
